...
export const SimulationQuirks = ({ isLightTheme }) => {
    return (
        ...
        <p className="sPText">
            ...
            easy fix, just find the modulus and make sure the angles are in the required domain. <br></br><br></br>
        ...
        <p className="sPText">
            ...
            be sure that my simulation is actually correct? <br></br><br></br>
