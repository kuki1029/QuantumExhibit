...
import { ThingsILearned } from "./ThingsILearned";
...
export const DoubPendExplanation = () => {
  ...
  return (
    <MathJaxContext>
      <h1>An Elegant Double Pendulum</h1>A list of features this double pendulum
      simulation has:
      <ul>
      ...
      <p className="sPText">
        The derivation is at the end or{" "}
        <button
          className="clickableText"
          onClick={() => derivationRef.current.scrollIntoView()}
        >
      ...
      <Motivation />
      <Button
        className="showDerButton"
        value="ShowDerivation"
        variant="outlined"
