export const ThingsLeanred = () => {
    return (
        ...
        <p className="sPText">
        This project has a main ticker in the background that constantly updates the pendulum's positions and 
        ...
        <p className="sPText">
            As I was working on this simulation, the codebase got large pretty quickly. There were just so many 
            components that were needed. Not only for the front end but also for all the calculations in the back end. There 
