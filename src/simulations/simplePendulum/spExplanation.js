...
export const SimePendExplanation = () => {
    ...
    return (
        ...
        {/* Physics Explanation */}
        <p className="sPText">My goal here was to recreate a simple pendulum using elementary physics principles. 
        ...
        <p className="sPText">
          ...
          on each side of the equation. We can replace acceleration with <MathJax inline>{"\\( L \\alpha \\)"}</MathJax> where <MathJax inline>{"\\( \\alpha \\)"}</MathJax> represents the
        ...
        <p className="sPText">
          We make use of this equation in the simulation. The initial angle is a result of solving the differential and we set 
        ...
        <p className="sPText">
          Aside from the actual physics involved, there are a few tricks I needed to use while calculating the position
