...
*/
export class ForwardEuler {
/**
 * Creates a forward euler solver with given initial conditions. IC's can be changed
...
/**
 * Does one step of Forward Euler. Makes use of the class variables 
